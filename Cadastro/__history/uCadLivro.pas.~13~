...
type
  ...
  private
    ...
    oLivro: TLivro;
    procedure ExportarCSV(ADataset: TDataSet); // Instância da nossa classe de negócio
  public
    { Public declarations }
...
begin
  // Cria o objeto e aponta a conexão
  oLivro := TLivro.Create(dtmPrincipal.dtmPrincipalDB);

  FDQListagem.Open;
  IndiceAtual := 'titulo'; // Define a busca padrão
  inherited;
end;
